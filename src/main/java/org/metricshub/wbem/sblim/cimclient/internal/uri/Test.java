...
public class Test {
	private static String cUriArray[] = {
		...
		"https://jdd:test@acme.com:5959/cimv2:CIM_RegisteredProfile." + "Cool=\"Hey! It's a string\"",
		...
		Util.quote( // "https://jdd:test@acme.com:5959/cimv2:CIM_RegisteredProfile."
			"root/cimv2:CIM_RegisteredProfile." + "Yeah=" + Util.quote("Gee! " + Util.quote("It's an embedded string"))
		),
		...
		",Ref=" +
		Util.quote( // "https://jdd:test@acme.com:5959/cimv2:CIM_RegisteredProfile."
			"CIM_RegisteredProfile." + "Yeah=" + Util.quote("Gee! " + Util.quote("It's an embedded string"))
		),
		...
		Util.quote("Gee! " + Util.quote("It's an embedded string")) +
		",Ref=" +
		Util.quote("CIM_RegisteredProfile." + "Yeah=" + Util.quote("Gee! " + Util.quote("It's an embedded string"))) +
		",CharKey0='a'" +
		",CharKey1='\\x32'" +
		",boolKeyT=True" +
		",boolKeyF=False" +
		...
		",Ref=(reference)" +
		Util.quote(
			"/(instance)CIM_RegisteredProfile." +
			"Yeah=(string)" +
			Util.quote("Gee! " + Util.quote("It's an embedded string")) +
			",ClassRef=(reference)" +
	...
	private static String getTypeStr(Value pVal) {
		if (pVal instanceof ReferenceValue) return "refValue"; else if (
			pVal instanceof StringValue
		) return "strValue"; else if (pVal instanceof CharValue) return "chrValue"; else if (
			pVal instanceof BooleanValue
		) return "boolValue"; else if (pVal instanceof DateTimeValue) return "dateTimeVal"; else if (
			pVal instanceof IntegerValue
		) return "intValue"; else if (pVal instanceof RealValue) return "realValue";
