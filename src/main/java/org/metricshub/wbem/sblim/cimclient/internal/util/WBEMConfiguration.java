...
public class WBEMConfiguration {
	...
	public static void loadGlobalConfiguration() {
		...
		try {
			...
			for (Iterator<Entry<Object, Object>> iterator = wbemProperties.entrySet().iterator(); iterator.hasNext();) {
	...
	public synchronized void setDomainProperties(Properties pDomainProperties) {
		if (isGlobal()) throw new IllegalStateException("Global configuration cannot be modified by setDomainProperties()");
		this.iDomainProperties = pDomainProperties;
	}
	...
	public synchronized void setDomainProperty(String pKey, String pValue) {
		if (isGlobal()) throw new IllegalStateException("Global configuration cannot be modified by setDomainProperty()");
	...
	public void setLocalProperties(Properties pLocalProperties) {
		if (isGlobal()) throw new IllegalStateException("Global configuration cannot be modified by setLocalProperties()");
	...
	public void setLocalProperty(String pKey, String pValue) {
		if (isGlobal()) throw new IllegalStateException("Global configuration cannot be modified by setLocalProperty()");
		Properties localProperties = (Properties) this.iLocalProperties.get();
	...
	private String getProperty(String pProperty, String pDefault) {
		...
		return (localProperty != null)
			? localProperty
			: (domainProperty != null) ? domainProperty : (globalProperty != null) ? globalProperty : pDefault;
	}
	...
	public Level getLogConsoleLevel() {
		return Level.parse(
			getProperty(WBEMConfigurationProperties.LOG_CONSOLE_LEVEL, WBEMConfigurationDefaults.LOG_CONSOLE_LEVEL)
		);
	}
	...
	public String getLogConsoleType() {
		return getProperty(WBEMConfigurationProperties.LOG_CONSOLE_TYPE, WBEMConfigurationDefaults.LOG_CONSOLE_TYPE);
	}
	...
	public Level getLogFileLevel() {
		return Level.parse(
			getProperty(WBEMConfigurationProperties.LOG_FILE_LEVEL, WBEMConfigurationDefaults.LOG_FILE_LEVEL)
		);
	}
	...
	public int getLogFileCount() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.LOG_FILE_COUNT, WBEMConfigurationDefaults.LOG_FILE_COUNT)
		);
	}
	...
	public int getLogFileSizeLimit() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.LOG_FILE_SIZE_LIMIT, WBEMConfigurationDefaults.LOG_FILE_SIZE_LIMIT)
		);
	}
	...
	public Level getTraceFileLevel() {
		return Level.parse(
			getProperty(WBEMConfigurationProperties.TRACE_FILE_LEVEL, WBEMConfigurationDefaults.TRACE_FILE_LEVEL)
		);
	}
	...
	public int getTraceFileCount() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.TRACE_FILE_COUNT, WBEMConfigurationDefaults.TRACE_FILE_COUNT)
		);
	}
	...
	public int getTraceFileSizeLimit() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.TRACE_FILE_SIZE_LIMIT, WBEMConfigurationDefaults.TRACE_FILE_SIZE_LIMIT)
		);
	}
	...
	public int getHttpTimeout() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.HTTP_TIMEOUT, WBEMConfigurationDefaults.HTTP_TIMEOUT)
		);
	}
	...
	public int getHttpPoolSize() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.HTTP_POOL_SIZE, WBEMConfigurationDefaults.HTTP_POOL_SIZE)
		);
	}
	...
	public String getHttpAuthenticationModule() {
		return getProperty(
			WBEMConfigurationProperties.HTTP_AUTHENTICATION_MODULE,
	...
	public boolean isHttpMPost() {
		return Boolean
			.valueOf(getProperty(WBEMConfigurationProperties.HTTP_USE_MPOST, WBEMConfigurationDefaults.HTTP_USE_MPOST))
			.booleanValue();
	}
	...
	public boolean isHttpChunked() {
		return Boolean
			.valueOf(getProperty(WBEMConfigurationProperties.HTTP_USE_CHUNKING, WBEMConfigurationDefaults.HTTP_USE_CHUNKING))
			.booleanValue();
	}
	...
	public String getHttpVersion() {
		return getProperty(WBEMConfigurationProperties.HTTP_VERSION, WBEMConfigurationDefaults.HTTP_VERSION);
	}
	...
	public String getSslKeyStoreType() {
		return getProperty(WBEMConfigurationProperties.KEYSTORE_TYPE, WBEMConfigurationDefaults.KEYSTORE_TYPE);
	}
	...
	public String getSslTrustStoreType() {
		return getProperty(WBEMConfigurationProperties.TRUSTSTORE_TYPE, WBEMConfigurationDefaults.TRUSTSTORE_TYPE);
	}
	...
	public String getSslSocketProvider() {
		...
		return getProperty(
			WBEMConfigurationProperties.SSL_SOCKET_PROVIDER,
	...
	public String getSslServerSocketProvider() {
		Provider[] providers = Security.getProviders("SSLContext.SSL");
		return getProperty(
			WBEMConfigurationProperties.SSL_SERVER_SOCKET_PROVIDER,
			providers != null && providers.length > 0 ? providers[0].getClass().getName() : null
		);
	}
	...
	public String getSslProtocol() {
		return getSecurityProperty(WBEMConfigurationProperties.SSL_PROTOCOL, WBEMConfigurationDefaults.SSL_DEF_PROTOCOL);
	}
	...
	public boolean getSslClientPeerVerification() {
		return Boolean
			.valueOf(
				getProperty(
					WBEMConfigurationProperties.SSL_CLIENT_PEER_VERIFICATION,
					WBEMConfigurationDefaults.SSL_CLIENT_PEER_VERIFICATION
				)
			)
			.booleanValue();
	}
	...
	public String getSslListenerPeerVerification() {
		return getProperty(
			WBEMConfigurationProperties.SSL_LISTENER_PEER_VERIFICATION,
	...
	public int getHttpConnectRetriesCount() {
		return Integer.parseInt(
			getProperty(
				WBEMConfigurationProperties.HTTP_CONNECTION_RETRIES,
	...
	public boolean isHttpContentLengthRetryEnabled() {
		return Boolean
			.valueOf(
				getProperty(
					WBEMConfigurationProperties.HTTP_ENABLE_CONTENT_LENGTH_RETRY,
					WBEMConfigurationDefaults.HTTP_ENABLE_CONTENT_LENGTH_RETRY
				)
			)
			.booleanValue();
	}
	...
	public String getCimXmlParser() {
		return getProperty(WBEMConfigurationProperties.CIMXML_PARSER, WBEMConfigurationDefaults.CIMXML_PARSER);
	}
	...
	public String getCimXmlEmbObjBuilder() {
		return getProperty(
			WBEMConfigurationProperties.CIMXML_EMBOBJBUILDER,
	...
	public boolean strictEmbObjTypes() {
		return Boolean
			.valueOf(
				getProperty(
					WBEMConfigurationProperties.CIMXML_PARSER_STRICT_EMBOBJ_TYPES,
	...
	public boolean upperCaseEmbObjEntities() {
		return Boolean
			.valueOf(
				getProperty(
					WBEMConfigurationProperties.CIMXML_BUILDER_UPPERCASE_EMBOBJ_ENTITIES,
	...
	public boolean performSslHandshake() {
		return Boolean
			.valueOf(
				getProperty(WBEMConfigurationProperties.PERFORM_SSL_HANDSHAKE, WBEMConfigurationDefaults.PERFORM_SSL_HANDSHAKE)
			)
			.booleanValue();
	}
	...
	public boolean synchronizedSslHandshake() {
		return Boolean
			.valueOf(
				getProperty(
					WBEMConfigurationProperties.SYNCHRONIZED_SSL_HANDSHAKE,
	...
	public boolean socketConnectWithTimeout() {
		return Boolean
			.valueOf(
				getProperty(
					WBEMConfigurationProperties.SOCKET_CONNECT_WITH_TIMEOUT,
					WBEMConfigurationDefaults.SOCKET_CONNECT_WITH_TIMEOUT
				)
			)
			.booleanValue();
	}
	...
	public int getSocketConnectTimeout() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.SOCKET_CONNECT_TIMEOUT, WBEMConfigurationDefaults.SOCKET_CONNECT_TIMEOUT)
		);
	}
	...
	public int getSocketIdleTimeout() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.SOCKET_IDLE_TIMEOUT, WBEMConfigurationDefaults.SOCKET_IDLE_TIMEOUT)
		);
	}
	...
	public boolean isDefaultAuthorizationEnabled() {
		return Boolean
			.valueOf(
				getProperty(
					WBEMConfigurationProperties.KEY_CREDENTIALS_DEFAULT_ENABLED,
					WBEMConfigurationDefaults.KEY_CREDENTIALS_DEFAULT_ENABLED
				)
			)
			.booleanValue();
	}
	...
	public String getDefaultPrincipal() {
		return getProperty(
			WBEMConfigurationProperties.KEY_DEFAULT_PRINCIPAL,
	...
	public String getDefaultCredentials() {
		return getProperty(
			WBEMConfigurationProperties.KEY_DEFAULT_CREDENTIAL,
	...
	public boolean isCimXmlTracingEnabled() {
		return Boolean
			.valueOf(getProperty(WBEMConfigurationProperties.CIMXML_TRACING, WBEMConfigurationDefaults.CIMXML_TRACING))
			.booleanValue();
	}
	...
	public int getListenerBacklog() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.LISTENER_BACKLOG, WBEMConfigurationDefaults.LISTENER_BACKLOG)
		);
	}
	...
	public int getListenerHttpTimeout() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.LISTENER_HTTP_TIMEOUT, WBEMConfigurationDefaults.LISTENER_HTTP_TIMEOUT)
		);
	}
	...
	public int getListenerMaxPoolSize() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.LISTENER_MAX_POOL_SIZE, WBEMConfigurationDefaults.LISTENER_MAX_POOL_SIZE)
		);
	}
	...
	public int getListenerMinPoolSize() {
		return Integer.parseInt(
			getProperty(WBEMConfigurationProperties.LISTENER_MIN_POOL_SIZE, WBEMConfigurationDefaults.LISTENER_MIN_POOL_SIZE)
		);
	}
	...
	public int getListenerMaxQueueSize() {
		return Integer.parseInt(
			getProperty(
				WBEMConfigurationProperties.LISTENER_MAX_QUEUE_SIZE,
	...
	public long getListenerMaxIdle() {
		return Long.parseLong(
			getProperty(
				WBEMConfigurationProperties.LISTENER_HANDLER_MAX_IDLE,
	...
	public int getListenerMaxQueuedEvents() {
		return Integer.parseInt(
			getProperty(
				WBEMConfigurationProperties.LISTENER_MAX_QUEUED_EVENTS,
	...
	public boolean isReliableIndicationEnabled() {
		return Boolean
			.valueOf(
				getProperty(
					WBEMConfigurationProperties.LISTENER_ENABLE_RELIABLE_INDICATIONS,
	...
	public boolean getListenerAddSenderIPAddress() {
		return Boolean
			.valueOf(
				getProperty(
					WBEMConfigurationProperties.LISTENER_ADD_SENDER_IP_ADDRESS,
					WBEMConfigurationDefaults.LISTENER_ADD_SENDER_IP_ADDRESS
				)
			)
			.booleanValue();
	}
	...
	public boolean verifyJavaLangDoubleStrings() {
		return Boolean
			.valueOf(
				getProperty(
					WBEMConfigurationProperties.VERIFY_JAVA_LANG_DOUBLE_STRINGS,
					WBEMConfigurationDefaults.VERIFY_JAVA_LANG_DOUBLE_STRINGS
				)
			)
			.booleanValue();
	}
	...
	public boolean synchronizeNumericKeyDataTypes() {
		return Boolean
			.valueOf(
				getProperty(
					WBEMConfigurationProperties.SYNCHRONIZE_NUMERIC_KEY_DATA_TYPES,
	...
	public boolean isGzipEncodingEnabled() {
		return Boolean
			.valueOf(
				getProperty(WBEMConfigurationProperties.ENABLE_GZIP_ENCODING, WBEMConfigurationDefaults.ENABLE_GZIP_ENCODING)
			)
			.booleanValue();
	}
	...
	public boolean useKeepAliveStrictMode() {
		return Boolean.valueOf(
			getProperty(
				WBEMConfigurationProperties.HTTP_KEEP_ALIVE_STRICT_MODE,
				WBEMConfigurationDefaults.HTTP_KEEP_ALIVE_STRICT_MODE
			)
		);
	}
}
