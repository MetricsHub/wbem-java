...
import org.metricshub.wbem.sblim.cimclient.internal.http.io.KeepAliveInputStream;
			...
			if (this.iReset && this.iResponse == null) {
				...
				do {
					...
					try {
						...
						if (iUseHttp11 && !iHttpClientPool.getConfigurationContext().useKeepAliveStrictMode()) {
							// AMMO-863 Systematic use of the Keep-alive
							// header is not recommended with HTTP/1.1
