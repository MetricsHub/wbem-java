...
/**
 * This class represents an <code>UnsignedInteger16</code>. A
 * <code>uint16</code> data type is defined by the (<a
...
public class UnsignedInteger16 extends Number implements Comparable<UnsignedInteger16> {
	...
	/**
	 * The maximum value for an <code>UnsignedInteger16</code>.
	 */
	public static final int MAX_VALUE = 65535;

	/**
	 * The minimum value for an <code>UnsignedInteger16</code>.
	 */
	 ...
	 *
	 * @param pValue
	 *            The integer to be represented as an unsigned 16-bit integer.
	 * @throws NumberFormatException
	...
	public int compareTo(UnsignedInteger16 pOther) {
		if (pOther == null) throw new IllegalArgumentException("Other UnsignedInteger16 cannot be null!");
	 ...
	 * <code>UnsignedInteger16</code> object that represents the same value as
	 * this object.
	 *
	 * @param pObj
	...
	public boolean equals(Object pObj) {
		if (!(pObj instanceof UnsignedInteger16)) return false;
